...
namespace sp_referee
{
    enum
    {
        ...
        EVENT_DATA_CMD = 0x0101,
        // EXT_SUPPLY_PROJECTILE_ACTION_CMD = 0x0102,  deleted
        ...
        BUFF_CMD = 0x0204,
        // AIR_SUPPORT_DATA_CMD = 0x0205,  deleted
        HURT_DATA_CMD = 0x0206,
        SHOOT_DATA_CMD = 0x0207,
        PROJECTILE_ALLOWANCE_CMD = 0x0208,
        RFID_STATUS_CMD = 0x0209,
        DART_CLIENT_CMD = 0x020A,
        GROUND_ROBOT_POSITION_CMD = 0X020B,
        RADAR_MARK_DATA_CMD = 0X020C,
        SENTRY_INFO_CMD = 0X020D,
        RADAR_INFO_CMD = 0X020E,
        ROBOT_INTERACTIVE_DATA_CMD = 0x0301,
        CUSTOM_ROBOT_DATA_CMD = 0X0302,
        MAP_COMMAND_CMD = 0X0303,
        REMOTE_CONTROL_CMD = 0X0304,
        MAP_ROBOT_DATA_CMD = 0x0305,
        // CUSTOM_CLIENT_DATA_CMD = 0X0306,  deleted
        MAP_DATA_CMD = 0X0307,
    ...
    enum
    {
        ...
        INTERACTION_LAYER_DELETE_CMD = 0X0100,
        INTERACTION_FIGURE_CMD = 0x0101,
        INTERACTION_FIGURE_TWO_CMD = 0x0101,
        INTERACTION_FIGURE_FIVE_CMD = 0x0103,
        INTERACTION_FIGURE_SEVEN_CMD= 0x0104,
        EXT_CLIENT_CUSTOM_CHARACTER_CMD = 0x0110,
        SENTRY_CMD_CMD = 0x0120,
        RADAR_CMD_CMD = 0x0121,
