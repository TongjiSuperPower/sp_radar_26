...
#include "camera_io/tools/thread_safe_queue.hpp"
...
{
public:
  HikRobot(double exposure_ms, double gain, const std::string & vid_pid, int rotation_angle = 0);
  HikRobot(
...
private:
  ...
  void rotate(const cv::Mat & src, cv::Mat & dst) const;
};
